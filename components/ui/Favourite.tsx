...
const Favourite = () => {
    return (
        <section className='bg-linear-180 grid min-h-screen md:px-0 px-6 py-16 place-items-center from-black from-purple-950 to-black'>
            ...
            <section className='flex md:flex-row flex-col justify-center gap-8 md:w-[70%] w-full min-h-screen md:mt-8 mt-4'>
                <div className='flex flex-col gap-6 w-full'>
                    <div className='backdrop-blur-md bg-white/5 border border-white/10 flex-[2] w-full p-8 rounded-[30px] hover:bg-white/10 transition-all duration-300 group'>
                    ...
                    <div className='backdrop-blur-md bg-white/5 border border-white/10 flex-[4] w-full p-8 rounded-[30px] relative overflow-hidden hover:bg-white/10 transition-all duration-300 group'>
